		...
		<form id="form1" name="form1" method="post" action="">
			<div class="Manager_style add_user_info search_style">
				<ul class="search_content clearfix">
					<button class="btn btn-primary addBtn" type="button" id="c-add-word" onclick="addORdetail(1)">新增白名单</button>
				</ul>
				<div id="Add_data_style" style="display: none">
					<div class="commonManager ">
						<div class="addCommon clearfix">
							<ul class="clearfix">
								<li>
									<label class="label_name">白名单名称</label>
									<label for="listName">
								...
								<li>
									<label class="label_name">白名单描述</label>
									<label for="listDesc">
                    ...
                    <div class="commonManager ">
                        <div class="addCommon clearfix">
                            <ul class="clearfix">
                                ...
                                <%--<li>
                                    <div>
                                        <input type="text" placeholder="搜索" class="whiteSea" name="searchKey" />
                                        <img src="../../resources/images/search.png" alt="" class="search_btn">
                                    </div>
                                </li>--%>
                                <li class="choose">选择</li>
